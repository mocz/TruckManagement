...
class TrucksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create truck" do
    assert_difference("Truck.count") do
      post trucks_url, params: { truck: { capacity: @truck.capacity, license_plate: @truck.license_plate, truck_id: @truck.truck_id } }
    end
  ...
  test "should update truck" do
    patch truck_url(@truck), params: { truck: { capacity: @truck.capacity, license_plate: @truck.license_plate, truck_id: @truck.truck_id } }
